...
from ckp.data_structure.segment_tree import FastSumSegmentTree, SumSegmentTree, AbstractSumSegmentTree
...
def bench_fast():
    res = TestDataGenerator.bench(FastSumSegmentTree(init_values), ops)
