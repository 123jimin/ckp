...
class TestAheuiPushIntNaive(unittest.TestCase):
    ...
    def assertOptimal(self, n: int, optimal_len: int):
        code = aheui_push_int_naive(n)
        self.assertEqual(len(code), optimal_len, f"Suboptimal for {n=}")
...
OPTIMAL_POS_INT_LEN = [
    ...
    5, 7, 7, 7, 7, 5, 5, 7, 5, 7, 7, 7, 7, 7, 7, 5, 5, 7, 7, 7,
    5, 7, 7, 7, 5, 7, 7, 5, 7, 7, 5, 7, 7, 5, 7, 7, 7, 7, 7, 7,
    5, 7, 5, 7, 7, 7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 5, 7, 7, 7, 7,
    ...
    5, 7, 7, 7, 7, 7, 7, 7, 5, 7, 7, 7, 7, 7, 5, 7, 7, 7, 7, 7,

    7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 5, 7, 7, 7, 7,
    5, 7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 5, 7, 7, 7,
    7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 9,
    5, 9, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 5, 7,
    7, 7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 7,

    7, 7, 7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 9, 9, 9,
    7, 9, 9, 7, 7, 7, 7, 7, 7, 7, 7, 9, 5, 7, 7, 7, 7, 7, 7, 7,
    7, 5, 7, 7, 7, 7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 7, 7, 7, 9, 7,
    8, 9, 7, 9, 7, 9, 9, 9, 7, 7, 9, 9, 7, 9, 7, 9, 7, 7, 7, 7,
    7, 7, 7, 7, 7, 9, 5, 9, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7,

    7, 7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 7, 5, 7, 7, 7, 7, 7, 7, 7,
    7, 7, 7, 9, 9, 7, 9, 9, 7, 9, 9, 7, 7, 8, 7, 9, 7, 9, 9, 7,
    7, 9, 9, 9, 7, 9, 7, 9, 9, 7, 9, 9, 7, 7, 9, 9, 9, 9, 7, 7,
    7, 7, 7, 7, 7, 7, 9, 5, 7, 7, 7, 7, 7, 7, 7, 7, 5, 9, 7, 7,
    7, 7, 7, 7, 7, 7, 9, 9, 7, 9, 9, 9, 7, 9, 7, 7, 9, 9, 9, 9,
    
    7, 9, 7, 7, 9, 7, 9, 9, 7, 7, 9, 9, 7, 9, 9, 9, 7, 8, 8, 8,
    8, 7, 8, 7, 7, 7, 9, 7, 7, 7, 7, 7, 7, 7, 7, 9, 9, 7, 9, 7,
    7, 7, 7, 7, 7, 7, 7, 9, 5, 9, 7, 7, 7, 7, 7, 7, 7, 7, 9, 9,
    9, 8, 9, 9, 7, 9, 7, 9, 9, 9, 9, 9, 7, 9, 9, 7, 7, 9, 9, 9,
    7, 9, 8, 9, 7, 9, 7, 9, 7, 9, 9, 9, 9, 7, 9, 9, 7, 9, 9, 9,

    7, 9, 7, 9, 7, 9, 9, 9, 9, 9, 9, 7, 7, 9, 7, 9, 9, 9, 9, 9,
    7, 7, 7, 7, 7, 7, 7, 7, 7, 5, 9, 7, 7, 7, 7, 7, 7, 7, 7, 9,
    8, 9, 9, 9, 9, 9, 9, 7, 9, 9, 7, 9, 9, 9, 9, 9, 7, 9, 9, 9,
    9, 9, 9, 9, 9, 7, 9, 9, 7, 9, 9, 9, 9, 9, 7, 8, 8, 8, 8, 8,
    8, 8, 8, 7, 7, 9, 7, 7, 7, 7, 7, 7, 7, 7, 9, 9, 9, 9, 9, 9,

    7, 7, 9, 9, 9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 9, 9, 7, 9, 9, 7,
    8, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 7, 7, 9, 9, 9, 9, 9, 9,
    7, 9, 9, 9, 9, 7, 9, 7, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9,
    9, 9, 9, 9, 7, 9, 9, 7, 9, 9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 9,
    9, 9, 7, 9, 9, 9, 9, 9, 9, 9, 9, 7, 8, 8, 8, 8, 7, 8, 8, 9,

    7, 9, 7, 7, 7, 7, 7, 7, 7, 7, 9, 9, 9, 9, 9, 9, 9, 9, 7, 9,
    9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 7, 8, 9, 9,
    9, 9, 9, 9, 9, 7, 9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 9, 9, 9, 9,
    7, 9, 9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 7, 9, 9, 9, 9, 9, 9, 9,
    7, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 8, 9, 9, 9, 9, 9, 9, 9,
]
...
OPTIMAL_NEG_INT_LEN = [
    ...
    9, 9, 7, 9, 7, 9, 9, 9, 7, 7, 9, 9, 7, 9, 7, 9, 7, 7, 7, 7,
    7, 7, 7, 7, 7, 9, 7, 9, 7, 9, 7, 9, 9, 9, 9, 7, 7, 7, 7, 7,

    7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 9, 9, 9, 9, 7, 9,
    7, 9, 7, 9, 9, 7, 9, 9, 7, 9, 9, 7, 7, 9, 9, 9, 7, 9, 9, 7,
    7, 9, 9, 9, 7, 9, 7, 9, 9, 7, 9, 9, 7, 7, 9, 9, 9, 9, 7, 7,
    7, 7, 7, 7, 7, 7, 9, 7, 7, 7, 7, 7, 7, 7, 7, 9, 7, 9, 9, 9,
    9, 9, 9, 9, 7, 7, 9, 9, 9, 9, 9, 9, 7, 9, 7, 9, 9, 9, 9, 9,

    7, 9, 9, 7, 9, 9, 9, 9, 7, 9, 9, 9, 7, 9, 9, 9, 7, 7, 7, 7,
    7, 7, 7, 7, 7, 9, 9, 9, 9, 9, 7, 9, 7, 9, 9, 9, 9, 9, 9, 7,
    7, 7, 7, 7, 7, 7, 7, 9, 7, 9, 9, 9, 9, 9, 9, 9, 9, 7, 9, 9,
    9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 9,
    9, 9, 9, 9, 7, 9, 9, 9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 9, 9, 9,

    9, 9, 7, 9, 9, 9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 9, 9, 9, 9, 9,
    7, 7, 7, 7, 7, 7, 7, 7, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9,
    ...
    9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9,
    9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9,
    9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 11, 9, 9, 9, 9, 9, 9,
    9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9,
